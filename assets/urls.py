...
from .views import (
    ...
    LeaseViewSet,
    asset_list,
    asset_ms_graph_asset_list,
    asset_ms_graph_user_list,
    asset_ms_graph_user_orbit,
    doc_list,
    doc_sim,
    report_dashboard,
    asset_ms_graph_user_list_generic,
    generic_ms_graph_user,
    generic_ms_graph_device,
    generic_db,
)
# ✅ API Router
...
urlpatterns = [
    ...
    path('generic_db/', generic_db, name='generic_db'),
